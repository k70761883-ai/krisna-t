            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f7f4f0]/90 backdrop-blur-sm border-b border-[#e5ddd4]/60">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <a href="#/public-booking"
                            className="text-xs px-3.5 py-1.5 rounded-full bg-[#c9a87c] hover:bg-[#b8956a] text-[#3d2e22] font-semibold tracking-[0.18em] uppercase transition-colors"
                            style={{ fontFamily: 'Montserrat, sans-serif' }}>
                            Booking
                        </a>
                        {whatsappUrl && (
                ...
                {menuOpen && (
                    <div className="md:hidden bg-[#f7f4f0] border-t border-[#e5ddd4] px-6 py-4 flex flex-col gap-4">
                        ...
                        <a href="#/public-booking"
                            className="text-sm text-[#c9a87c] font-semibold tracking-[0.15em] uppercase"
                            style={{ fontFamily: 'Montserrat, sans-serif' }}
                            onClick={() => setMenuOpen(false)}
                        >
                            Booking Online
            ...
            <section id="hero" className="relative w-full h-screen flex items-end overflow-hidden">
                ...
                <div className="relative z-10 px-8 md:px-16 pb-16 md:pb-24 max-w-3xl">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <a href="#/public-packages"
                            className="inline-flex items-center gap-2 bg-white text-[#3d2e22] text-xs font-semibold tracking-[0.2em] uppercase px-6 py-3 hover:bg-[#f7f4f0] transition-all duration-300 shadow-md"
                            style={{ fontFamily: 'Montserrat, sans-serif' }}>
                            View Packages
                        </a>
                        <a href="#/public-booking"
                            className="inline-flex items-center gap-2 bg-[#c9a87c] text-[#3d2e22] text-xs font-semibold tracking-[0.2em] uppercase px-6 py-3 hover:bg-[#b8956a] transition-all duration-300 shadow-md"
                            style={{ fontFamily: 'Montserrat, sans-serif' }}>
                            Book Now
                        </a>
                        {whatsappUrl && (
                            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 border border-white/50 text-white text-xs tracking-[0.2em] uppercase px-6 py-3 hover:bg-white hover:text-[#3d2e22] transition-all duration-300"
                                style={{ fontFamily: 'Montserrat, sans-serif' }}>
