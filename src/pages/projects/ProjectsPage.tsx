    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-brand-surface p-2.5 md:p-4 rounded-xl shadow-lg border border-brand-border flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-2.5 lg:gap-3">
                    <div className="input-group flex-grow !mt-0 w-full lg:w-auto">
                        <input
                            type="search"
                            value={searchTerm}
                            onChange={e => setSearchTerm(e.target.value)}
                            className="input-field !rounded-lg !border !bg-brand-bg py-1.5 px-2.5 md:p-2.5 text-xs md:text-sm"
                            placeholder=" "
                        />
                        <label className="input-label text-xs md:text-sm">Cari Acara Pernikahan...</label>
                    </div>
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full lg:w-auto">
                        <div className="grid grid-cols-2 gap-2 w-full sm:w-auto">
                            <div className="flex items-center gap-1.5 overflow-hidden">
                                <CalendarIcon className="w-3.5 h-3.5 md:w-4 md:h-4 text-brand-text-secondary flex-shrink-0 hidden sm:block" />
                                <input
                                    type="date"
                                    value={dateFrom}
                                    onChange={e => setDateFrom(e.target.value)}
                                    className="input-field !rounded-lg !border !bg-brand-bg py-1.5 px-2 md:p-2 text-xs md:text-sm w-full sm:w-36"
                                    title="Dari tanggal"
                                />
                            </div>
                            <input
                        ...
                        <div className="grid grid-cols-2 sm:flex items-center gap-2 w-full sm:w-auto">
                            <select
                                ...
                                className="input-field !rounded-lg !border !bg-brand-bg py-1.5 px-2 md:p-2.5 text-xs md:text-sm w-full sm:w-44"
                            >
                            ...
                            <div className="p-0.5 md:p-1 bg-brand-bg border border-brand-border/60 rounded-lg flex items-center h-[34px] md:h-10 w-full sm:w-auto justify-center">
                                <button
                                    onClick={() => setViewMode('list')}
                                    className={`flex-1 sm:flex-none flex items-center justify-center px-2 md:px-3 py-1 md:py-1.5 rounded-md text-[10px] md:text-xs font-semibold transition-colors h-full ${
                                        viewMode === 'list'
                                ...
                                >
                                    <ListIcon className="w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0" />
                                </button>
                                <button
                                ...
                                >
                                    <LayoutGridIcon className="w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0" />
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                {viewMode === 'list' ? (
                    <div className="bg-brand-surface rounded-2xl shadow-lg border border-brand-border overflow-hidden">
                        <div className="p-2.5 md:p-4 border-b border-brand-border flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 md:gap-3">
                            <div className="flex items-center gap-1 p-0.5 md:p-1 bg-brand-bg/80 rounded-lg md:rounded-xl border border-brand-border/60">
                                <button
                                    type="button"
                                    onClick={() => setProjectListTab('active')}
                                    className={`flex-1 sm:flex-none px-2 py-1.5 md:px-3 md:py-1.5 text-[10px] md:text-xs font-semibold rounded-md md:rounded-lg transition-all truncate text-center ${
                            ...
                            <div className="text-[10px] md:text-xs text-brand-text-secondary text-right">
