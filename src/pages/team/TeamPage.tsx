...
import { markTeamPaymentStatus, listAllTeamPayments, updateTeamPaymentFee, updateTeamProjectPayments as updateTeamProjectPaymentsApi } from '../../services/teamProjectPayments';
import { createTransaction as createTransactionApi, updateCardBalance as updateCardBalanceApi, listTransactions as listTransactionsApi, createTransactions as createTransactionsApi } from '../../services/transactions';
        ...
        try {
            if (formMode === 'add') {
                ...
                try {
                    ...
                    const { id, ...restSelectedMember } = selectedMember;
                    const payload: Omit<TeamMember, 'id'> = {
                        ...restSelectedMember,
                        ...formData,
                    };
    ...
    const handlePay = async () => {
        ...
        try {
            ...
            for (const pay of selectedPayments) {
                ...
                if (isFullyPaid) {
                    paymentsToUpdate.push({ ...pay, status: 'Paid' });
                } else {
                    paymentsToUpdate.push({ ...pay, fee: pay.fee - payForThisProject, status: 'Unpaid' });
                }
            }
