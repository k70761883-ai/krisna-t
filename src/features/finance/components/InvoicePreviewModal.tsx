    ...
    >
      <div className="space-y-4">
        ...
        <div
          ...
          className="bg-white text-slate-900 border border-slate-200 rounded-xl shadow-sm p-6 sm:p-10 font-sans print:shadow-none print:border-none print:p-0"
        >
          {/* Header Section */}
          <div className="flex flex-col sm:flex-row justify-between items-start gap-6 border-b-2 border-slate-100 pb-6">
            {/* Vendor Branding */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 py-6 border-b border-slate-100">
            ...
            <div className="space-y-2 sm:text-right">
              ...
              <div className="text-xs text-slate-600 space-y-1 sm:space-y-0 sm:space-y-reverse">
                <p>
              ...
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b-2 border-slate-200 bg-slate-50 text-slate-700">
                    <th className="py-3 px-3 text-center font-bold w-12 uppercase tracking-wider">#</th>
                    <th className="py-3 px-4 text-left font-bold uppercase tracking-wider">Deskripsi Layanan / Item</th>
                    <th className="py-3 px-3 text-center font-bold w-20 uppercase tracking-wider">Qty</th>
                    <th className="py-3 px-4 text-right font-bold w-32 uppercase tracking-wider">Harga Satuan</th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {formData.lineItems && formData.lineItems.length > 0 ? (
                    formData.lineItems.map((item, idx) => (
                      <tr key={item.id || idx} className="hover:bg-slate-50/60 transition-colors">
                        <td className="py-3.5 px-3 text-center font-semibold text-slate-400">{idx + 1}</td>
                        ...
                        <td className="py-3.5 px-3 text-center font-medium text-slate-700">{item.quantity || 1}</td>
                  ...
                  {/* Transport Cost as additional row if present */}
                  {formData.transportCost > 0 && (
                    <tr className="bg-slate-50/40">
                      ...
                      <td className="py-3 px-4">
                        ...
                        <p className="text-[11px] text-slate-500 mt-0.5">Akomodasi dan transportasi kru ke lokasi acara</p>
                      </td>
            ...
            <div className="space-y-4">
              ...
              {formData.notes && (
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed whitespace-pre-line bg-slate-50 p-3 rounded-lg border border-slate-100">
                    {formData.notes}
                  </p>
                </div>
              )}
