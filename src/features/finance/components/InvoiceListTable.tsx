          ...
          <div key={`${doc.kind}-${doc.id}`} className="p-3 hover:bg-brand-bg/40 transition-colors">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                ...
                {onEdit && doc.kind === 'invoice' && doc.project && (
                  <button
                    onClick={() => onEdit(doc)}
                    className="p-1.5 rounded-lg text-brand-text-secondary hover:text-amber-500 hover:bg-amber-500/10 transition-all"
                    title="Edit invoice & rincian"
                  >
                    <EditIcon />
                  </button>
                )}
