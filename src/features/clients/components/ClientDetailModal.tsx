                    ...
                    <div className="p-4 sm:p-5 space-y-5">
                      ...
                      <div className="flex items-center gap-2 pt-1">
                        ...
                        <button
                          ...
                          className="w-9 !py-2 rounded-xl border border-brand-border text-brand-text-secondary hover:text-red-600 hover:border-red-200 hover:bg-red-50 transition-all active:scale-95 flex items-center justify-center flex-shrink-0"
                          title="Hapus Acara"
                        >
