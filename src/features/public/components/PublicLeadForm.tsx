    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="w-full max-w-2xl bg-white rounded-lg shadow-xl overflow-hidden">
                ...
                <div className="relative text-white p-8 sm:p-12 text-center bg-gray-900 overflow-hidden">
                    {/* Background Image & Overlay */}
                    <div className="absolute inset-0 z-0">
                        <img src="/assets/images/backgrounds/detail-pengantin-4.jpg" alt="Background" className="w-full h-full object-cover opacity-50" />
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <Logo />
                        <h1 className="text-3xl font-light text-white mt-6 mb-2 font-serif drop-shadow-md">
                            Konsultasi Pernikahan
                        </h1>
                        <p className="text-gray-300 text-sm tracking-wider uppercase drop-shadow-md">
                            Inquiry Form
                        </p>
                    </div>
                </div>
